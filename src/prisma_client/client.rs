...
pub mod rooms {
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_rooms { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: rooms struct $ struct_name { # [serde (rename = "id")] pub id : i32 , # [serde (rename = "name")] pub name : String , # [serde (rename = "capacity")] pub capacity : i32 , # [serde (rename = "createdAt")] pub created_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "updatedAt")] pub updated_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > } [$ ($ scalar_field) , +] } } ; }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create(self, name: String, capacity: i32, mut _params: Vec<SetParam>) -> Create<'a> {
            _params.extend([name::set(name), capacity::set(capacity)]);
            Create::new(self.client, _params)
        }
        pub fn create_unchecked(
            self,
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (name, capacity, mut _params): (String, i32, Vec<SetParam>),
            _update: Vec<SetParam>,
        ) -> Upsert<'a> {
            _params.extend([name::set(name), capacity::set(capacity)]);
            Upsert::new(self.client, _where.into(), _params, _update)
